<template>
  <div>
    <el-row>
      ...
      <template slot-scope="scope">
        <el-tag
          :type="scope.row.is_ok === '正常' ? 'success' : scope.row.status === '生成中' ? 'warning':'danger'"
          disable-transitions
          >{{ scope.row.is_ok }}</el-tag
        >
        ...
        <el-table-column label="操作">
          <template slot-scope="scope">
            ...
            <el-button
              size="mini"
              type="success"
              @click="cancel_data(scope.$index)"
              v-if="scope.row.edit_class == 'add'"
              >取消</el-button
            >
...
export default {
  data() {
    return {
      ...
      table_header: [
         {
          header_data: "target_class",
          header_label: "指标分类",
          placeholder: "生成方式",
        } ,
        {
          header_data: "target_second_class",
          header_label: "指标二级分类",
          placeholder: "生成方式",
        } ,
        {
          header_data: "target_name",
          header_label: "指标名称",
          placeholder: "生成方式",
        },
        {
          header_data: "target_english_name",
          header_label: "指标英文名称",
          placeholder: "生成方式",
        },
        {
          header_data: "query_name",
          header_label: "查询语句",
          placeholder: "请输入种类",
        },
        {
          header_data: "target_unit",
          header_label: "指标单位",
          placeholder: "生成方式",
        },
        {
